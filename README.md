...
```mermaid
  graph TD;
      UNTRACKEDGIT_ADD-->STAGED_TRACKED(READY_TO_COMMIT)GIT_COMMIT;
      STAGED_TRACKED(READY_TO_COMMIT)GIT_COMMIT-->TRACKEDCHANGES;
      TRACKEDCHANGES-->MODIFIED(CHANGED)GIT_ADD;
